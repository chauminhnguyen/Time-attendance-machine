...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        render = PhotoImage(file='./app/homepagepic.png')
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        tk.Label(self, text="Enter ID", fg="#263942",
        ...
        self.user_id.grid(row=0, column=1, pady=10, padx=10)
        tk.Label(self, text="Enter the name", fg="#263942",
                 font='Helvetica 12 bold').grid(row=1, column=0, pady=10, padx=5)
    ...
    def start_training(self):
        ...
        if self.user_id.get() == "None":
            ...
            return
        elif self.user_id.get() in names:
        ...
        names.add(name)
        self.controller.active_name = name + '_' + id
        self.controller.frames["PageTwo"].refresh_names()
        self.controller.show_frame(
            "PageThree", (self.user_name.get(), self.user_id.get()))
...
class PageThree(tk.Frame):
    ...
    def openwebcam(self):
        main_app(self.args[0], self.args[1])
...
app = MainUI()
app.iconphoto(False, tk.PhotoImage(file='./app/icon.ico'))
app.mainloop()
